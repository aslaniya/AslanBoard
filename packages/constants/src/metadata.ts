...
export const SITE_NAME = "AslanBoard | Simple, extensible, open-source project management tool.";
export const SITE_TITLE = "AslanBoard | Simple, extensible, open-source project management tool.";
...
export const SPACE_SITE_NAME = "AslanBoard Publish | Make your AslanBoard boards and roadmaps public with just one-click. ";
export const SPACE_SITE_TITLE = "AslanBoard Publish | Make your AslanBoard boards public with one-click";
export const SPACE_SITE_DESCRIPTION = "AslanBoard Publish is a customer feedback management tool built on top of AslanBoard";
