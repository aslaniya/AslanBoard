...
const APP_TITLE = "AslanBoard Publish | Make your AslanBoard boards public with one-click";
const APP_DESCRIPTION = "AslanBoard Publish is a customer feedback management tool built on top of AslanBoard";
