...
const APP_TITLE = "AslanBoard | Simple, extensible, open-source project management tool.";
  ...
  return (
    <html lang="en" suppressHydrationWarning>
      <head>
        ...
        {/* Meta info for PWA */}
        <meta name="application-name" content="AslanBoard" />
...
export const meta: Route.MetaFunction = () => [
  ...
  { property: "og:image:alt", content: "AslanBoard - Modern project management" },
  {
    name: "keywords",
    content:
  ...
  { name: "twitter:image:alt", content: "AslanBoard - Modern project management" },
];
